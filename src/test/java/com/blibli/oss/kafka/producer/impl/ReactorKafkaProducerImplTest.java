...
public class ReactorKafkaProducerImplTest {
  ...
  @InjectMocks
  private ReactorKafkaProducerImpl kafkaProducer;
  ...
  public void testSend() {
    ...
    SendResult<String, String> result = kafkaProducer.send(TOPIC, KEY, MESSAGE, PARTITION, TIMESTAMP).block();
